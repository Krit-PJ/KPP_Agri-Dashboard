...
- แสดงภาพรวมจำนวนระเบียนทั้งหมด เผยแพร่ ฉบับร่าง และเก็บถาวร
...
- แชร์ Google Sheet ให้เจ้าหน้าที่เฉพาะบัญชีที่ต้องใช้งาน โดยกำหนดเป็น `Editor`
- ผู้ที่เป็น `Viewer` เปิด Dashboard และข้อมูลสาธารณะได้ แต่ใช้ Admin Data Manager ไม่ได้
- ไม่ต้องใส่รหัสผ่านหรือ Token ใน Source Code ของ Dashboard
- ตรวจสอบผู้ดำเนินการ เวลา และกิจกรรมย้อนหลังได้ในชีต `_Audit_Log`
