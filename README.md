...
### Dashboard รุ่น 4.4.4

- เลือกปีล่าสุดที่มีข้อมูลจริงสำหรับพืชแต่ละชนิดโดยอัตโนมัติ
- ปิดการเลือกปีที่พืชปัจจุบันไม่มีระเบียน เพื่อไม่แสดง KPI เป็นศูนย์จนเข้าใจว่าเชื่อมข้อมูลไม่สำเร็จ
- ปุ่มเลือกทุกปีและปีล่าสุดอ้างอิงเฉพาะปีที่พืชนั้นมีข้อมูล
